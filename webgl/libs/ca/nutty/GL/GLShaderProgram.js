...
// <returns>True if the shaders linked to the program sucessfully, otherwise
// false.</returns>
...
// <param name="name">Name of the variable referenced in the shader
// program.</param>
...
// <param name="name">Name of the matrix referenced in the shader
// program.</param>
// <param name="matrix">Matrix data.</param>
// <param name="size">Size of the matrix. Valid range is between 2 - 4 (2x2 -
// 4x4).</param>
