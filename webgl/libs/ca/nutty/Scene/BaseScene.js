...
BaseScene.prototype.start = function() {
	...
	for (var i = 0; i < this.mResource.items.length; ++i) {
		...
		if ((httpState.resource.uri.lastIndexOf(".jpg") >= 0) || (httpState.resource.uri.lastIndexOf(".png") >= 0)) {
			var image = new Image();
...
BaseScene.prototype.onItemLoaded = function(sender, response) {++this.mResourceCount;
