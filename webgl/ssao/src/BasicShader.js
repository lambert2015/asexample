...
BasicShader.prototype.enable = function ()
{
	...
	{
		var lightId = this.mLightId[i];
		var light = this.lightObject[i];
		this.setVariableInt(lightId.typeId, light.lightType);
		this.setVariableVec3(lightId.positionId, light.position);
		this.setVariableVec3(lightId.attenuationId, light.attenuation);
		this.setVariableVec3(lightId.directionId, light.direction);
		this.setVariableVec3(lightId.colourId, light.colour);
		this.setVariable(lightId.outerCutoffId, light.outerCutoff);
		this.setVariable(lightId.innerCutoffId, light.innerCutoff);
		this.setVariable(lightId.exponentId, light.exponent);
	}
}
