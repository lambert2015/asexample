package away3d.extrusions
{
	...
	public class Elevation extends Mesh
	{
		...
		*/
		public function Elevation(material:MaterialBase, heightMap:BitmapData, width:Number = 1000, height:Number = 100, depth:Number = 1000, segmentsW:uint = 30, segmentsH:uint = 30, maxElevation:uint =
			255, minElevation:uint = 0, smoothMap:Boolean = false)
		{
