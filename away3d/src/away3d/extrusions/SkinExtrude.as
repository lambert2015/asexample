package away3d.extrusions
{
	...
	public class SkinExtrude extends Mesh
	{
		...
		*/
		public function SkinExtrude(material:MaterialBase, profiles:Vector.<Vector.<Vector3D>>, subdivision:uint = 1, centerMesh:Boolean = false, closeShape:Boolean = false, coverAll:Boolean = false, flip:Boolean =
			false)
		{
