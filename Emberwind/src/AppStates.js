...
ScreenTransitionFade.prototype.draw = function(render) {
	...
	var color = new Pixel32(lerp(this.from.r, this.to.r, this.t / this.maxT), lerp(this.from.g, this.to.g, this.t / this.maxT), lerp(this.from.b, this.to.b, this.t / this.maxT), lerp(this.from.a, this.to.a, this.t / this.maxT));
	if (color.a > 0) {
...
LoadingStageState.prototype.draw = function(render) {
	...
	render.drawText(this.progressText, (render.getWidth() - this.progressText.width) / 2, render.getHeight() / 2 - this.progressText.height / 2, alpha);
};
...
InGameState.prototype.draw = function(render) {
	if (!render.frontToBack)
		this.host.game.draw(render);
...
InGameState.prototype.resume = function(msg, fromState) {
	if (fromState == appStates.kStateYesNoDialog)
		this.startInGameTrack();
	this.restartDelay = 0;
};
...
IntroState.prototype.enter = function(msg, fromState) {
	...
	var images = ["atlas/gui/titlescreen0.png", "atlas/no_c_red/titlescreen1.png", "atlas/gui/titlescreen2.png", "atlas/no_c_red/titlescreen3.png", "atlas/no_c_red/titlescreen4.png", "atlas/no_c_red/storyboardintro.png", "atlas/gui/titletext_html5.png", "atlas/gui/titlescreen_wick_eyes.png", "atlas/gui/titlescreen_kindle_eyes.png", "atlas/game/timetrap.png", "localized/english/Copyright.png", "atlas/gui/button.png", "atlas/storyboards/storyboard1.png", "atlas/storyboards/storyboard2.png", "atlas/storyboards/storyboard3.png", "atlas/storyboards/storyboard4.png", "atlas/gui/textbubble.png", "localized/english/controls_mac_pc.png"];
...
function formatScore(s) {
	s = Math.floor(s);
	if (s >= 1000000)
		return Math.floor(s / 1000000) + "," + pad(Math.floor((s % 1000000) / 1000)) + "," + pad(s % 1000);
	else if (s >= 1000)
		return Math.floor(s / 1000) + "," + pad(s % 1000);
	return s;
}
...
StoryboardState.prototype.nextState = function() {
	...
	this.timeInCurrentState = 0; ++this.currentState;
