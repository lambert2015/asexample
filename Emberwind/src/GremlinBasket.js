function GremlinBasket() {
	...
	this.spawnsPerSecond = 0.5;
	// From GameParameters.cpp
	this.maxSpawned = 2;
	this.numSpawned = 0;
	this.timer = 0;
...
GremlinBasket.prototype.draw = function(render, x, y) {
	...
	HittableGameObject.prototype.draw.call(this, render, Math.floor(this.getPos().x) + x, Math.floor(this.getPos().y) + y);
};
