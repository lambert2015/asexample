...
Void AssetData_obj::initialize( ){
{
		...
		if ((!(::nme::AssetData_obj::initialized))){
			HX_STACK_LINE(21)
			::nme::AssetData_obj::path->set(HX_CSTRING("libraries/library.swf"),HX_CSTRING("libraries/library.swf"));
			HX_STACK_LINE(22)
			{
				HX_STACK_LINE(22)
				::nme::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::nme::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(22)
				::nme::AssetData_obj::type->set(HX_CSTRING("libraries/library.swf"),value);
			}
			HX_STACK_LINE(24)
			{
				HX_STACK_LINE(24)
				::nme::LibraryType value = ::Reflect_obj::field(hx::ClassOf< ::nme::LibraryType >(),HX_CSTRING("swf").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(24)
				::nme::AssetData_obj::library->set(HX_CSTRING("library"),value);
			}
			HX_STACK_LINE(26)
