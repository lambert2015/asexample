...
::haxe::ds::StringMap Assets_obj::cachedSWFLibraries;
		...
		if (((bool(::nme::AssetData_obj::type->exists(id)) && bool((::nme::AssetData_obj::type->get(id) == ::nme::AssetType_obj::IMAGE))))){
			...
			if (((id.indexOf(HX_CSTRING(":"),null()) > (int)-1))){
				...
				if ((::nme::AssetData_obj::library->exists(libraryName))){
					HX_STACK_LINE(128)
					if (((::nme::AssetData_obj::library->get(libraryName) == ::nme::LibraryType_obj::SWF))){
						HX_STACK_LINE(134)
						if ((!(::nme::Assets_obj::cachedSWFLibraries->exists(libraryName)))){
							HX_STACK_LINE(134)
							::nme::Assets_obj::cachedSWFLibraries->set(libraryName,::format::SWF_obj::__new(::nme::Assets_obj::getBytes(((HX_CSTRING("libraries/") + libraryName) + HX_CSTRING(".swf")))));
						}
						HX_STACK_LINE(150)
						return ::nme::Assets_obj::cachedSWFLibraries->get(libraryName)->__Field(HX_CSTRING("getBitmapData"),true)(symbolName);
					}
				}
				else{
					HX_STACK_LINE(172)
...
::format::display::MovieClip Assets_obj::getMovieClip( ::String id){
	...
	if ((::nme::AssetData_obj::library->exists(libraryName))){
		...
		if (((::nme::AssetData_obj::library->get(libraryName) == ::nme::LibraryType_obj::SWF))){
			...
			HX_STACK_LINE(322)
			return ::nme::Assets_obj::cachedSWFLibraries->get(libraryName)->__Field(HX_CSTRING("createMovieClip"),true)(symbolName);
		}
	}
	else{
		HX_STACK_LINE(344)
...
Dynamic Assets_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 16:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"cachedSWFLibraries") ) { return cachedSWFLibraries; }
	}
...
Dynamic Assets_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 16:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"cachedSWFLibraries") ) { cachedSWFLibraries=inValue.Cast< ::haxe::ds::StringMap >(); return inValue; }
	}
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Assets_obj::cachedSWFLibraries,"cachedSWFLibraries");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Assets_obj::cachedSWFLibraries,"cachedSWFLibraries");
...
void Assets_obj::__boot()
{
	...
	cachedSWFLibraries= ::haxe::ds::StringMap_obj::__new();
	initialized= false;
}
