...
{
HX_STACK_PUSH("Process::new","C:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",100);
{
	struct _Function_1_1{
		inline static Dynamic Block( ::String &cmd,Array< ::String > &args){
			HX_STACK_PUSH("*::closure","C:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",101);
			{
				HX_STACK_LINE(101)
				try{
					HX_STACK_LINE(101)
...
{
		HX_STACK_PUSH("Process::close","C:\\HaxeFoundation\\haxe/std/cpp/_std/sys/io/Process.hx",115);
		HX_STACK_THIS(this);
		HX_STACK_LINE(115)
