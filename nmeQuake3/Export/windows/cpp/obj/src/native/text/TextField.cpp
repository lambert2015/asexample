...
#include <native/text/GridFitType.h>
#endif
...
{
HX_STACK_PUSH("TextField::new","native/text/TextField.hx",38);
{
	HX_STACK_LINE(39)
	...
	HX_STACK_LINE(41)
	this->gridFitType = ::native::text::GridFitType_obj::PIXEL;
	HX_STACK_LINE(42)
...
bool TextField_obj::set_wordWrap( bool inVal){
	HX_STACK_PUSH("TextField::set_wordWrap","native/text/TextField.hx",126);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_wordWrap( ){
	HX_STACK_PUSH("TextField::get_wordWrap","native/text/TextField.hx",125);
	HX_STACK_THIS(this);
	HX_STACK_LINE(125)
...
::native::text::TextFieldType TextField_obj::set_type( ::native::text::TextFieldType inType){
	HX_STACK_PUSH("TextField::set_type","native/text/TextField.hx",124);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inType,"inType");
	HX_STACK_LINE(124)
	::native::text::TextField_obj::nme_text_field_set_type(this->nmeHandle,(inType == ::native::text::TextFieldType_obj::INPUT));
	HX_STACK_LINE(124)
	return inType;
}
...
::native::text::TextFieldType TextField_obj::get_type( ){
	HX_STACK_PUSH("TextField::get_type","native/text/TextField.hx",123);
	HX_STACK_THIS(this);
	HX_STACK_LINE(123)
	return (  ((::native::text::TextField_obj::nme_text_field_get_type(this->nmeHandle))) ? ::native::text::TextFieldType(::native::text::TextFieldType_obj::INPUT) : ::native::text::TextFieldType(::native::text::TextFieldType_obj::DYNAMIC) );
}
...
Float TextField_obj::get_textHeight( ){
	HX_STACK_PUSH("TextField::get_textHeight","native/text/TextField.hx",122);
	HX_STACK_THIS(this);
	HX_STACK_LINE(122)
...
Float TextField_obj::get_textWidth( ){
	HX_STACK_PUSH("TextField::get_textWidth","native/text/TextField.hx",121);
	HX_STACK_THIS(this);
	HX_STACK_LINE(121)
...
int TextField_obj::set_textColor( int inCol){
	HX_STACK_PUSH("TextField::set_textColor","native/text/TextField.hx",120);
	HX_STACK_THIS(this);
...
int TextField_obj::get_textColor( ){
	HX_STACK_PUSH("TextField::get_textColor","native/text/TextField.hx",119);
	HX_STACK_THIS(this);
	HX_STACK_LINE(119)
...
::String TextField_obj::set_text( ::String inText){
	HX_STACK_PUSH("TextField::set_text","native/text/TextField.hx",118);
	HX_STACK_THIS(this);
...
::String TextField_obj::get_text( ){
	HX_STACK_PUSH("TextField::get_text","native/text/TextField.hx",117);
	HX_STACK_THIS(this);
	HX_STACK_LINE(117)
...
bool TextField_obj::set_selectable( bool inSel){
	HX_STACK_PUSH("TextField::set_selectable","native/text/TextField.hx",116);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_selectable( ){
	HX_STACK_PUSH("TextField::get_selectable","native/text/TextField.hx",115);
	HX_STACK_THIS(this);
	HX_STACK_LINE(115)
...
int TextField_obj::set_scrollV( int inVal){
	HX_STACK_PUSH("TextField::set_scrollV","native/text/TextField.hx",114);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(114)
...
int TextField_obj::get_scrollV( ){
	HX_STACK_PUSH("TextField::get_scrollV","native/text/TextField.hx",113);
	HX_STACK_THIS(this);
	HX_STACK_LINE(113)
...
int TextField_obj::set_scrollH( int inVal){
	HX_STACK_PUSH("TextField::set_scrollH","native/text/TextField.hx",112);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(112)
...
int TextField_obj::get_scrollH( ){
	HX_STACK_PUSH("TextField::get_scrollH","native/text/TextField.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_LINE(111)
...
int TextField_obj::get_numLines( ){
	HX_STACK_PUSH("TextField::get_numLines","native/text/TextField.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_LINE(110)
...
bool TextField_obj::set_multiline( bool inVal){
	HX_STACK_PUSH("TextField::set_multiline","native/text/TextField.hx",109);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(109)
...
bool TextField_obj::get_multiline( ){
	HX_STACK_PUSH("TextField::get_multiline","native/text/TextField.hx",108);
	HX_STACK_THIS(this);
	HX_STACK_LINE(108)
...
int TextField_obj::get_maxScrollV( ){
	HX_STACK_PUSH("TextField::get_maxScrollV","native/text/TextField.hx",107);
	HX_STACK_THIS(this);
	HX_STACK_LINE(107)
...
int TextField_obj::get_maxScrollH( ){
	HX_STACK_PUSH("TextField::get_maxScrollH","native/text/TextField.hx",106);
	HX_STACK_THIS(this);
	HX_STACK_LINE(106)
...
int TextField_obj::set_maxChars( int inVal){
	HX_STACK_PUSH("TextField::set_maxChars","native/text/TextField.hx",105);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(105)
...
int TextField_obj::get_maxChars( ){
	HX_STACK_PUSH("TextField::get_maxChars","native/text/TextField.hx",104);
	HX_STACK_THIS(this);
	HX_STACK_LINE(104)
...
::String TextField_obj::set_htmlText( ::String inText){
	HX_STACK_PUSH("TextField::set_htmlText","native/text/TextField.hx",103);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inText,"inText");
	HX_STACK_LINE(103)
...
::String TextField_obj::get_htmlText( ){
	HX_STACK_PUSH("TextField::get_htmlText","native/text/TextField.hx",102);
	HX_STACK_THIS(this);
	HX_STACK_LINE(102)
...
bool TextField_obj::set_embedFonts( bool value){
	HX_STACK_PUSH("TextField::set_embedFonts","native/text/TextField.hx",101);
	HX_STACK_THIS(this);
...
bool TextField_obj::get_embedFonts( ){
	HX_STACK_PUSH("TextField::get_embedFonts","native/text/TextField.hx",100);
	HX_STACK_THIS(this);
	HX_STACK_LINE(100)
	return true;
}
...
bool TextField_obj::set_displayAsPassword( bool inVal){
	HX_STACK_PUSH("TextField::set_displayAsPassword","native/text/TextField.hx",99);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(99)
...
bool TextField_obj::get_displayAsPassword( ){
	HX_STACK_PUSH("TextField::get_displayAsPassword","native/text/TextField.hx",98);
	HX_STACK_THIS(this);
	HX_STACK_LINE(98)
...
::native::text::TextFormat TextField_obj::set_defaultTextFormat( ::native::text::TextFormat inFormat){
	HX_STACK_PUSH("TextField::set_defaultTextFormat","native/text/TextField.hx",97);
	HX_STACK_THIS(this);
...
::native::text::TextFormat TextField_obj::get_defaultTextFormat( ){
	HX_STACK_PUSH("TextField::get_defaultTextFormat","native/text/TextField.hx",96);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
...
int TextField_obj::get_bottomScrollV( ){
	HX_STACK_PUSH("TextField::get_bottomScrollV","native/text/TextField.hx",95);
	HX_STACK_THIS(this);
	HX_STACK_LINE(95)
...
int TextField_obj::set_borderColor( int inVal){
	HX_STACK_PUSH("TextField::set_borderColor","native/text/TextField.hx",94);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(94)
...
int TextField_obj::get_borderColor( ){
	HX_STACK_PUSH("TextField::get_borderColor","native/text/TextField.hx",93);
	HX_STACK_THIS(this);
	HX_STACK_LINE(93)
...
bool TextField_obj::set_border( bool inVal){
	HX_STACK_PUSH("TextField::set_border","native/text/TextField.hx",92);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(92)
...
bool TextField_obj::get_border( ){
	HX_STACK_PUSH("TextField::get_border","native/text/TextField.hx",91);
	HX_STACK_THIS(this);
	HX_STACK_LINE(91)
...
int TextField_obj::set_backgroundColor( int inVal){
	HX_STACK_PUSH("TextField::set_backgroundColor","native/text/TextField.hx",90);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(90)
...
int TextField_obj::get_backgroundColor( ){
	HX_STACK_PUSH("TextField::get_backgroundColor","native/text/TextField.hx",89);
	HX_STACK_THIS(this);
	HX_STACK_LINE(89)
...
bool TextField_obj::set_background( bool inVal){
	HX_STACK_PUSH("TextField::set_background","native/text/TextField.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(88)
...
bool TextField_obj::get_background( ){
	HX_STACK_PUSH("TextField::get_background","native/text/TextField.hx",87);
	HX_STACK_THIS(this);
	HX_STACK_LINE(87)
...
::native::text::TextFieldAutoSize TextField_obj::set_autoSize( ::native::text::TextFieldAutoSize inVal){
	HX_STACK_PUSH("TextField::set_autoSize","native/text/TextField.hx",86);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inVal,"inVal");
	HX_STACK_LINE(86)
...
::native::text::TextFieldAutoSize TextField_obj::get_autoSize( ){
	HX_STACK_PUSH("TextField::get_autoSize","native/text/TextField.hx",85);
	HX_STACK_THIS(this);
	HX_STACK_LINE(85)
...
int endIndex = __o_endIndex.Default(-1);
	HX_STACK_PUSH("TextField::setTextFormat","native/text/TextField.hx",80);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("TextField::setSelection","native/text/TextField.hx",75);
		HX_STACK_THIS(this);
		HX_STACK_ARG(beginIndex,"beginIndex");
		HX_STACK_ARG(endIndex,"endIndex");
	}
...
::native::text::TextFormat TextField_obj::getTextFormat( hx::Null< int >  __o_beginIndex,hx::Null< int >  __o_endIndex){
int beginIndex = __o_beginIndex.Default(-1);
int endIndex = __o_endIndex.Default(-1);
	HX_STACK_PUSH("TextField::getTextFormat","native/text/TextField.hx",68);
	HX_STACK_THIS(this);
	HX_STACK_ARG(beginIndex,"beginIndex");
	HX_STACK_ARG(endIndex,"endIndex");
{
		...
		::native::text::TextFormat result = ::native::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(70)
		::native::text::TextField_obj::nme_text_field_get_text_format(this->nmeHandle,result,beginIndex,endIndex);
		HX_STACK_LINE(71)
		return result;
	}
}
...
::native::text::TextLineMetrics TextField_obj::getLineMetrics( int lineIndex){
	HX_STACK_PUSH("TextField::getLineMetrics","native/text/TextField.hx",61);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lineIndex,"lineIndex");
	HX_STACK_LINE(62)
	::native::text::TextLineMetrics result = ::native::text::TextLineMetrics_obj::__new(null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(63)
	::native::text::TextField_obj::nme_text_field_get_line_metrics(this->nmeHandle,lineIndex,result);
	HX_STACK_LINE(64)
	return result;
}
...
::String TextField_obj::getLineText( int lineIndex){
	HX_STACK_PUSH("TextField::getLineText","native/text/TextField.hx",56);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lineIndex,"lineIndex");
	HX_STACK_LINE(56)
...
int TextField_obj::getLineOffset( int lineIndex){
	HX_STACK_PUSH("TextField::getLineOffset","native/text/TextField.hx",51);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lineIndex,"lineIndex");
	HX_STACK_LINE(51)
...
{
		HX_STACK_PUSH("TextField::appendText","native/text/TextField.hx",46);
		HX_STACK_THIS(this);
...
Dynamic TextField_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"gridFitType") ) { gridFitType=inValue.Cast< ::native::text::GridFitType >(); return inValue; }
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.TextField"), hx::TCanCast< TextField_obj> ,sStaticFields,sMemberFields,
...
void TextField_obj::__boot()
{
	...
	nme_text_field_get_text_format= ::native::Loader_obj::load(HX_CSTRING("nme_text_field_get_text_format"),(int)4);
	...
	nme_text_field_get_line_metrics= ::native::Loader_obj::load(HX_CSTRING("nme_text_field_get_line_metrics"),(int)3);
