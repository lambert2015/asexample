...
::native::text::FontType FontType_obj::DEVICE;

::native::text::FontType FontType_obj::EMBEDDED;

::native::text::FontType FontType_obj::EMBEDDED_CFF;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.FontType"), hx::TCanCast< FontType_obj >,sStaticFields,sMemberFields,
	&__Create_FontType_obj, &__Create,
	&super::__SGetClass(), &CreateFontType_obj, sMarkStatics, sVisitStatic);
}
