...
class HXCPP_CLASS_ATTRIBUTES  TextField_obj : public ::native::display::InteractiveObject_obj{
	public:
	...
	public:
		...
		virtual ::native::text::TextFormat getTextFormat( hx::Null< int >  beginIndex,hx::Null< int >  endIndex);
		Dynamic getTextFormat_dyn();

		virtual ::native::text::TextLineMetrics getLineMetrics( int lineIndex);
		...
		int maxScrollV;
		int maxScrollH;
		::native::text::GridFitType gridFitType;
		int bottomScrollV;
		::native::text::AntiAliasType antiAliasType;
