...
::native::display::JointStyle JointStyle_obj::BEVEL;

::native::display::JointStyle JointStyle_obj::MITER;

::native::display::JointStyle JointStyle_obj::ROUND;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.JointStyle"), hx::TCanCast< JointStyle_obj >,sStaticFields,sMemberFields,
	&__Create_JointStyle_obj, &__Create,
	&super::__SGetClass(), &CreateJointStyle_obj, sMarkStatics, sVisitStatic);
}
