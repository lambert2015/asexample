...
::native::text::FontStyle FontStyle_obj::BOLD;

::native::text::FontStyle FontStyle_obj::BOLD_ITALIC;

::native::text::FontStyle FontStyle_obj::ITALIC;

::native::text::FontStyle FontStyle_obj::REGULAR;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.FontStyle"), hx::TCanCast< FontStyle_obj >,sStaticFields,sMemberFields,
