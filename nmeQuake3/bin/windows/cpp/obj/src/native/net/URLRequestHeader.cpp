...
{
HX_STACK_PUSH("URLRequestHeader::new","native/net/URLRequestHeader.hx",10);
{
	HX_STACK_LINE(11)
	this->name = name;
	HX_STACK_LINE(12)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.net.URLRequestHeader"), hx::TCanCast< URLRequestHeader_obj> ,sStaticFields,sMemberFields,
