...
bool EventDispatcher_obj::willTrigger( ::String type){
	HX_STACK_PUSH("EventDispatcher::willTrigger","native/events/EventDispatcher.hx",138);
	HX_STACK_THIS(this);
...
::String EventDispatcher_obj::toString( ){
	HX_STACK_PUSH("EventDispatcher::toString","native/events/EventDispatcher.hx",133);
	HX_STACK_THIS(this);
	HX_STACK_LINE(133)
...
bool capture = __o_capture.Default(false);
	HX_STACK_PUSH("EventDispatcher::removeEventListener","native/events/EventDispatcher.hx",110);
	HX_STACK_THIS(this);
	HX_STACK_ARG(type,"type");
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	HX_STACK_PUSH("EventDispatcher::hasEventListener","native/events/EventDispatcher.hx",93);
	HX_STACK_THIS(this);
	HX_STACK_ARG(type,"type");
	HX_STACK_LINE(94)
	if (((this->nmeEventMap == null()))){
...
{
		HX_STACK_PUSH("EventDispatcher::DispatchIOErrorEvent","native/events/EventDispatcher.hx",87);
		HX_STACK_THIS(this);
		HX_STACK_LINE(88)
...
bool EventDispatcher_obj::dispatchEvent( ::native::events::Event event){
	HX_STACK_PUSH("EventDispatcher::dispatchEvent","native/events/EventDispatcher.hx",41);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("EventDispatcher::DispatchCompleteEvent","native/events/EventDispatcher.hx",35);
		HX_STACK_THIS(this);
		HX_STACK_LINE(36)
