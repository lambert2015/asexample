package org.angle3d.cinematic.event
{
	...
	public class AbstractCinematicEvent implements CinematicEvent
	{
		...
		public function AbstractCinematicEvent(initialDuration:Float = 10, mode:int = 0)
		{
			super();
