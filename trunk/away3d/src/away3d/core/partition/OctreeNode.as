	...
	public class OctreeNode extends NodeBase
	{
		...
		private function findPartitionForBounds(entityWorldBounds:Vector.<Number>):OctreeNode
		{
			...
			if (top)
			{
				...
				{
					if (left)
						return _leftTopNear.findPartitionForBounds(entityWorldBounds);
					else
						return _rightTopNear.findPartitionForBounds(entityWorldBounds);
				}
				else
				{
					if (left)
						return _leftTopFar.findPartitionForBounds(entityWorldBounds);
					else
						return _rightTopFar.findPartitionForBounds(entityWorldBounds);
				}
			}
			else
			{
				...
				{
					if (left)
						return _leftBottomNear.findPartitionForBounds(entityWorldBounds);
					else
						return _rightBottomNear.findPartitionForBounds(entityWorldBounds);
				}
				else
				{
					if (left)
						return _leftBottomFar.findPartitionForBounds(entityWorldBounds);
					else
						return _rightBottomFar.findPartitionForBounds(entityWorldBounds);
				}
			}
		}
	}
