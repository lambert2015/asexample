package away3d.debug
{
	...
	public class AwayStats extends Sprite
	{
		 ...
		 * respectively.
		 */
		public function AwayStats(view3d:View3D = null, minimized:Boolean = false, transparent:Boolean = false, meanDataLength:uint = 0, enableClickToReset:Boolean = true, enableModifyFrameRate:Boolean =
			true)
		{
			super();
