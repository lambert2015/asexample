...
class Spatial implements Cloneable implements Collidable
{
	...
	private var cullHint:Int;
	
	/** 
     * Spatial's bounding volume relative to the world.
     */
	private var _worldBound:BoundingVolume;
	...
	// scale values
	private var frustrumIntersects:Int;
	private var queueBucket:Int;
	private var shadowMode:Int;
	...
	public inline function getRefreshFlags():UInt
	{
		return refreshFlags;
	}
     ...
     */
	private inline function _getParent():Node
	{
		return _parent;
	}
     ...
     */
	private inline function _setParent(parent:Node):Node
	{
		_parent = parent;
		return _parent;
	}
     ...
     */
	public function getQueueBucket():Int
	{
     ...
     * @see ShadowMode
     */
	public function getShadowMode():Int
	{
     ...
     */
	public function getLocalCullHint():Int
	{
		return cullHint;
	}
     ...
     */
	public function getCullHint():Int
	{
     ...
     */
	public function setQueueBucket(queueBucket:Int):Void
	{
     ...
     */
	public function getLocalQueueBucket():Int
	{
		return queueBucket;
	}
     ...
     * @see Spatial#setShadowMode(org.angle3d.renderer.queue.RenderQueue.ShadowMode)
     */
	public function getLocalShadowMode():Int
	{
		return shadowMode;
	}
     ...
     */
	public function getLastFrustumIntersection():Int
	{
     ...
     *            the new value
     */
	public function setLastFrustumIntersection(intersects:Int):Void
	{
