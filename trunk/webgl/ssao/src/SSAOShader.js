// SSAO is a post-processing shader that computes the amount of ambient occlusion
// at each
// fragment. This shader requires 3 textures and outputs one luninance floating
// point texture.
//
// 1. Texture map containing the 3D view-space positions.
// 2. Texture map containing the 3D view-space normal vectors.
// 3. A normalmap to be used when randomizing the kernel filter to produce
// noisier, but uniform results.
//
// The resulting output from this shader can be blended with the original
// rendered scene.
