...
three.cameras.Camera.prototype = $extend(three.core.Object3D.prototype,{
	...
	,far: null
	,near: null
	,_viewMatrixArray: null
	,_projectionMatrixArray: null
...
three.materials = {}
three.materials.CubeRefractionMapping = function() {
};
$hxClasses["three.materials.CubeRefractionMapping"] = three.materials.CubeRefractionMapping;
three.materials.CubeRefractionMapping.__name__ = ["three","materials","CubeRefractionMapping"];
three.materials.CubeRefractionMapping.prototype = {
	__class__: three.materials.CubeRefractionMapping
}
...
three.materials.Material.prototype = {
	...
	,_shadowPass: null
	,numSupportedMorphNormals: null
	,numSupportedMorphTargets: null
	,attributes: null
	,wrapAround: null
	,perPixel: null
	,metal: null
...
three.materials.LineBasicMaterial = function() {
	three.materials.Material.call(this);
};
$hxClasses["three.materials.LineBasicMaterial"] = three.materials.LineBasicMaterial;
three.materials.LineBasicMaterial.__name__ = ["three","materials","LineBasicMaterial"];
three.materials.LineBasicMaterial.__super__ = three.materials.Material;
three.materials.LineBasicMaterial.prototype = $extend(three.materials.Material.prototype,{
	__class__: three.materials.LineBasicMaterial
});
...
three.materials.MeshDepthMaterial = function() {
	three.materials.Material.call(this);
};
$hxClasses["three.materials.MeshDepthMaterial"] = three.materials.MeshDepthMaterial;
three.materials.MeshDepthMaterial.__name__ = ["three","materials","MeshDepthMaterial"];
three.materials.MeshDepthMaterial.__super__ = three.materials.Material;
three.materials.MeshDepthMaterial.prototype = $extend(three.materials.Material.prototype,{
	__class__: three.materials.MeshDepthMaterial
});
three.materials.MeshLambertMaterial = function() {
	three.materials.Material.call(this);
};
$hxClasses["three.materials.MeshLambertMaterial"] = three.materials.MeshLambertMaterial;
three.materials.MeshLambertMaterial.__name__ = ["three","materials","MeshLambertMaterial"];
three.materials.MeshLambertMaterial.__super__ = three.materials.Material;
three.materials.MeshLambertMaterial.prototype = $extend(three.materials.Material.prototype,{
	__class__: three.materials.MeshLambertMaterial
});
...
three.materials.MeshPhongMaterial = function() {
	three.materials.Material.call(this);
};
$hxClasses["three.materials.MeshPhongMaterial"] = three.materials.MeshPhongMaterial;
three.materials.MeshPhongMaterial.__name__ = ["three","materials","MeshPhongMaterial"];
three.materials.MeshPhongMaterial.__super__ = three.materials.Material;
three.materials.MeshPhongMaterial.prototype = $extend(three.materials.Material.prototype,{
	__class__: three.materials.MeshPhongMaterial
});
three.materials.ParticleBasicMaterial = function() {
	three.materials.Material.call(this);
};
$hxClasses["three.materials.ParticleBasicMaterial"] = three.materials.ParticleBasicMaterial;
three.materials.ParticleBasicMaterial.__name__ = ["three","materials","ParticleBasicMaterial"];
three.materials.ParticleBasicMaterial.__super__ = three.materials.Material;
three.materials.ParticleBasicMaterial.prototype = $extend(three.materials.Material.prototype,{
	__class__: three.materials.ParticleBasicMaterial
});
...
three.renderers = {}
three.renderers.IPlugin = function() { }
$hxClasses["three.renderers.IPlugin"] = three.renderers.IPlugin;
three.renderers.IPlugin.__name__ = ["three","renderers","IPlugin"];
three.renderers.IPlugin.prototype = {
	render: null
	,__class__: three.renderers.IPlugin
}
...
three.renderers.IPostRenderPlugin.__interfaces__ = [three.renderers.IPlugin];
...
three.renderers.IPreRenderPlugin.__interfaces__ = [three.renderers.IPlugin];
...
$hxClasses["three.renderers.Program3D"] = three.renderers.Program3D;
three.renderers.Program3D.__name__ = ["three","renderers","Program3D"];
...
three.renderers.Uniform = function() {
};
$hxClasses["three.renderers.Uniform"] = three.renderers.Uniform;
three.renderers.Uniform.__name__ = ["three","renderers","Uniform"];
three.renderers.Uniform.prototype = {
	_array: null
	,texture: null
	,value: null
	,type: null
	,__class__: three.renderers.Uniform
}
...
three.renderers.WebGLRenderer = function(parameters) {
	...
	this._canvas = parameters.canvas != null?parameters.canvas:js.Boot.__cast(js.Lib.document.createElement("canvas") , js.w3c.html5.HTMLCanvasElement);
	this._precision = parameters.precision != null?parameters.precision:"highp";
	this._alpha = parameters.alpha != null?parameters.alpha:true;
	this._premultipliedAlpha = parameters.premultipliedAlpha != null?parameters.premultipliedAlpha:true;
	this._antialias = parameters.antialias != null?parameters.antialias:false;
	this._stencil = parameters.stencil != null?parameters.stencil:true;
	this._preserveDrawingBuffer = parameters.preserveDrawingBuffer != null?parameters.preserveDrawingBuffer:false;
	this._clearColor = parameters.clearColor != null?new three.math.Color(parameters.clearColor):new three.math.Color(0);
	this._maxLights = parameters.maxLights != null?parameters.maxLights:4;
	...
	this._frustum = new three.core.Frustum();
	this._projScreenMatrix = new three.math.Matrix4();
	this._projScreenMatrixPS = new three.math.Matrix4();
	this._vector3 = new three.math.Vector4();
	this._direction = new three.math.Vector3();
	this._lightsNeedUpdate = true;
	this._lights = { ambient : [0,0,0], directional : { length : 0, colors : [], positions : []}, point : { length : 0, colors : [], positions : [], distances : []}, spot : { length : 0, colors : [], positions : [], distances : [], directions : [], angles : [], exponents : []}};
	this.initGL();
	this.setDefaultGLState();
	this._maxVertexTextures = this.gl.getParameter(this.gl.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
	this._maxTextureSize = this.gl.getParameter(this.gl.MAX_TEXTURE_SIZE);
	this._maxCubemapSize = this.gl.getParameter(this.gl.MAX_CUBE_MAP_TEXTURE_SIZE);
...
three.renderers.WebGLRenderer.prototype = {
	getShader: function(type,source) {
		var shader = null;
		if(type == "fragment") shader = this.gl.createShader(this.gl.FRAGMENT_SHADER); else if(type == "vertex") shader = this.gl.createShader(this.gl.VERTEX_SHADER);
		this.gl.shaderSource(shader,source);
		this.gl.compileShader(shader);
		if(!this.gl.getShaderParameter(shader,this.gl.COMPILE_STATUS)) {
			three.utils.Logger.error(this.gl.getShaderInfoLog(shader));
			three.utils.Logger.error(this.addLineNumbers(source));
			return null;
		}
		return shader;
	}
	,addLineNumbers: function(source) {
		var chunks = source.split("\n");
		var _g1 = 0, _g = chunks.length;
		while(_g1 < _g) {
			var i = _g1++;
	...
	,cacheAttributeLocations: function(program,identifiers) {
		var id;
		var _g1 = 0, _g = identifiers.length;
		while(_g1 < _g) {
			var i = _g1++;
			id = identifiers[i];
			program.attributes[id] = this.gl.getAttribLocation(program.program,id);
		}
	}
	,cacheUniformLocations: function(program,identifiers) {
		...
		while(_g1 < _g) {
			var i = _g1++;
			id = identifiers[i];
			program.uniforms[id] = this.gl.getUniformLocation(program.program,id);
		}
	}
	,buildProgram: function(shaderID,fragmentShader,vertexShader,uniforms,attributes,parameters) {
		var p, pl;
		var program;
		var code;
		var chunks = [];
		if(shaderID != "") chunks.push(shaderID); else {
			chunks.push(fragmentShader);
			chunks.push(vertexShader);
		}
		var fields = Type.getClassFields(parameters);
		var _g = 0;
		while(_g < fields.length) {
			var p1 = fields[_g];
			++_g;
			chunks.push(p1);
			chunks.push(parameters[p1]);
		}
		code = chunks.join("");
		var _g1 = 0, _g = this._programs.length;
		while(_g1 < _g) {
			var p1 = _g1++;
			var programInfo = this._programs[p1];
		...
		var prefix_vertex = ["precision " + this._precision + " float;",this._supportsVertexTextures?"#define VERTEX_TEXTURES":"",this.gammaInput?"#define GAMMA_INPUT":"",this.gammaOutput?"#define GAMMA_OUTPUT":"",this.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"","#define MAX_DIR_LIGHTS " + Std.string(parameters.maxDirLights),"#define MAX_POINT_LIGHTS " + Std.string(parameters.maxPointLights),"#define MAX_SPOT_LIGHTS " + Std.string(parameters.maxSpotLights),"#define MAX_SHADOWS " + Std.string(parameters.maxShadows),"#define MAX_BONES " + Std.string(parameters.maxBones),parameters.map?"#define USE_MAP":"",parameters.envMap?"#define USE_ENVMAP":"",parameters.lightMap?"#define USE_LIGHTMAP":"",parameters.bumpMap?"#define USE_BUMPMAP":"",parameters.specularMap?"#define USE_SPECULARMAP":"",parameters.vertexColors?"#define USE_COLOR":"",parameters.skinning?"#define USE_SKINNING":"",parameters.useVertexTexture?"#define BONE_TEXTURE":"",parameters.boneTextureWidth?"#define N_BONE_PIXEL_X " + Std.string(parameters.boneTextureWidth.toFixed(1)):"",parameters.boneTextureHeight?"#define N_BONE_PIXEL_Y " + Std.string(parameters.boneTextureHeight.toFixed(1)):"",parameters.morphTargets?"#define USE_MORPHTARGETS":"",parameters.morphNormals?"#define USE_MORPHNORMALS":"",parameters.perPixel?"#define PHONG_PER_PIXEL":"",parameters.wrapAround?"#define WRAP_AROUND":"",parameters.doubleSided?"#define DOUBLE_SIDED":"",parameters.shadowMapEnabled?"#define USE_SHADOWMAP":"",parameters.shadowMapSoft?"#define SHADOWMAP_SOFT":"",parameters.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",parameters.shadowMapCascade?"#define SHADOWMAP_CASCADE":"",parameters.sizeAttenuation?"#define USE_SIZEATTENUATION":"","uniform mat4 modelMatrix;","uniform mat4 modelViewMatrix;","uniform mat4 projectionMatrix;","uniform mat4 viewMatrix;","uniform mat3 normalMatrix;","uniform vec3 cameraPosition;","attribute vec3 position;","attribute vec3 normal;","attribute vec2 uv;","attribute vec2 uv2;","#ifdef USE_COLOR","attribute vec3 color;","#endif","#ifdef USE_MORPHTARGETS","attribute vec3 morphTarget0;","attribute vec3 morphTarget1;","attribute vec3 morphTarget2;","attribute vec3 morphTarget3;","#ifdef USE_MORPHNORMALS","attribute vec3 morphNormal0;","attribute vec3 morphNormal1;","attribute vec3 morphNormal2;","attribute vec3 morphNormal3;","#else","attribute vec3 morphTarget4;","attribute vec3 morphTarget5;","attribute vec3 morphTarget6;","attribute vec3 morphTarget7;","#endif","#endif","#ifdef USE_SKINNING","attribute vec4 skinVertexA;","attribute vec4 skinVertexB;","attribute vec4 skinIndex;","attribute vec4 skinWeight;","#endif",""].join("\n");
		var prefix_fragment = ["precision " + this._precision + " float;",parameters.bumpMap?"#extension GL_OES_standard_derivatives : enable":"","#define MAX_DIR_LIGHTS " + Std.string(parameters.maxDirLights),"#define MAX_POINT_LIGHTS " + Std.string(parameters.maxPointLights),"#define MAX_SPOT_LIGHTS " + Std.string(parameters.maxSpotLights),"#define MAX_SHADOWS " + Std.string(parameters.maxShadows),parameters.alphaTest?"#define ALPHATEST " + Std.string(parameters.alphaTest):"",this.gammaInput?"#define GAMMA_INPUT":"",this.gammaOutput?"#define GAMMA_OUTPUT":"",this.physicallyBasedShading?"#define PHYSICALLY_BASED_SHADING":"",parameters.useFog && parameters.fog?"#define USE_FOG":"",parameters.useFog && js.Boot.__instanceof(parameters.fog,three.scenes.FogExp2)?"#define FOG_EXP2":"",parameters.map?"#define USE_MAP":"",parameters.envMap?"#define USE_ENVMAP":"",parameters.lightMap?"#define USE_LIGHTMAP":"",parameters.bumpMap?"#define USE_BUMPMAP":"",parameters.specularMap?"#define USE_SPECULARMAP":"",parameters.vertexColors?"#define USE_COLOR":"",parameters.metal?"#define METAL":"",parameters.perPixel?"#define PHONG_PER_PIXEL":"",parameters.wrapAround?"#define WRAP_AROUND":"",parameters.doubleSided?"#define DOUBLE_SIDED":"",parameters.shadowMapEnabled?"#define USE_SHADOWMAP":"",parameters.shadowMapSoft?"#define SHADOWMAP_SOFT":"",parameters.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",parameters.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;",""].join("\n");
		...
		if(!this.gl.getProgramParameter(program,this.gl.LINK_STATUS)) three.utils.Logger.error("Could not initialise shader\n" + "VALIDATE_STATUS: " + Std.string(this.gl.getProgramParameter(program,this.gl.VALIDATE_STATUS)) + ", gl error [" + this.gl.getError() + "]");
		this.gl.deleteShader(glFragmentShader);
		this.gl.deleteShader(glVertexShader);
		var program3D = new three.renderers.Program3D();
		...
		if(parameters.useVertexTexture) identifiers.push("boneTexture"); else identifiers.push("boneGlobalMatrices");
		var fields1 = Type.getClassFields(uniforms);
		var _g = 0;
		...
		this.cacheUniformLocations(program3D,identifiers);
		identifiers = ["position","normal","uv","uv2","tangent","color","skinVertexA","skinVertexB","skinIndex","skinWeight"];
		var _g1 = 0, _g = parameters.maxMorphTargets;
		while(_g1 < _g) {
			var i1 = _g1++;
			identifiers.push("morphTarget" + i1);
		}
		var _g1 = 0, _g = parameters.maxMorphNormals;
		while(_g1 < _g) {
			var i1 = _g1++;
			identifiers.push("morphNormal" + i1);
		}
		var fields2 = Type.getClassFields(attributes);
		var _g = 0;
		while(_g < fields2.length) {
			var a1 = fields2[_g];
			++_g;
			identifiers.push(a1);
		}
		this.cacheAttributeLocations(program3D,identifiers);
		program3D.id = three.renderers.WebGLRenderer._programs_counter++;
		var pInfo = { program : program3D, code : code, usedTimes : 1};
		this._programs.push(pInfo);
	...
	,setBlending: function(blending,blendEquation,blendSrc,blendDst) {
		if(blending != this._oldBlending) {
			if(blending == 0) this.gl.disable(this.gl.BLEND); else if(blending == 2) {
			...
			} else if(blending == 5) this.gl.enable(this.gl.BLEND); else {
				this.gl.enable(this.gl.BLEND);
		...
		if(blending == 5) {
			if(blendEquation != this._oldBlendEquation) {
				this.gl.blendEquation(three.ThreeGlobal.paramThreeToGL(blendEquation));
				this._oldBlendEquation = blendEquation;
			}
			if(blendSrc != this._oldBlendSrc || blendDst != this._oldBlendDst) {
				this.gl.blendFunc(three.ThreeGlobal.paramThreeToGL(blendSrc),three.ThreeGlobal.paramThreeToGL(blendDst));
	...
	,setPolygonOffset: function(polygonoffset,factor,units) {
		if(this._oldPolygonOffset != polygonoffset) {
			if(polygonoffset > 0) this.gl.enable(this.gl.POLYGON_OFFSET_FILL); else this.gl.disable(this.gl.POLYGON_OFFSET_FILL);
			this._oldPolygonOffset = polygonoffset;
		}
		if(polygonoffset > 0 && (this._oldPolygonOffsetFactor != factor || this._oldPolygonOffsetUnits != units)) {
	...
	,setupLights: function(program,lights) {
		...
		while(_g1 < _g) {
			...
			if(js.Boot.__instanceof(light,three.lights.AmbientLight)) {
				if(this.gammaInput) {
					r += color.r * color.r;
					g += color.g * color.g;
					b += color.b * color.b;
			...
			} else if(js.Boot.__instanceof(light,three.lights.DirectionalLight)) {
				doffset = dlength * 3;
				if(this.gammaInput) {
				...
				this._direction.copy(light.matrixWorld.getPosition());
				this._direction.subSelf(light.target.matrixWorld.getPosition());
				this._direction.normalize();
				dpositions[doffset] = this._direction.x;
				dpositions[doffset + 1] = this._direction.y;
				dpositions[doffset + 2] = this._direction.z;
				dlength += 1;
			} else if(js.Boot.__instanceof(light,three.lights.PointLight)) {
				poffset = plength * 3;
				if(this.gammaInput) {
				...
				plength += 1;
			} else if(js.Boot.__instanceof(light,three.lights.SpotLight)) {
				var spotLight = js.Boot.__cast(light , three.lights.SpotLight);
				soffset = slength * 3;
				if(this.gammaInput) {
				...
				this._direction.subSelf(light.target.matrixWorld.getPosition());
				this._direction.normalize();
				sdirections[soffset] = this._direction.x;
				sdirections[soffset + 1] = this._direction.y;
				sdirections[soffset + 2] = this._direction.z;
				sangles[slength] = Math.cos(spotLight.angle);
				sexponents[slength] = spotLight.exponent;
				slength += 1;
			}
		}
		var _g1 = dlength * 3, _g = dcolors.length;
		while(_g1 < _g) {
			var l = _g1++;
			dcolors[l] = 0.0;
		}
		var _g1 = plength * 3, _g = pcolors.length;
		while(_g1 < _g) {
			var l = _g1++;
			pcolors[l] = 0.0;
		}
		var _g1 = slength * 3, _g = scolors.length;
		while(_g1 < _g) {
			var l = _g1++;
			scolors[l] = 0.0;
		}
	...
	,loadUniformsGeneric: function(program,uniforms) {
		var uniform;
		var value;
		var type;
		var location;
		...
		while(_g1 < _g) {
			...
			type = uniform.type;
			value = uniform.value;
			if(type == "i") this.gl.uniform1i(location,value); else if(type == "f") this.gl.uniform1f(location,value); else if(type == "v2") {
				var vec2 = js.Boot.__cast(value , three.math.Vector2);
				this.gl.uniform2f(location,vec2.x,vec2.y);
			} else if(type == "v3") {
				var vec3 = js.Boot.__cast(value , three.math.Vector3);
				this.gl.uniform3f(location,vec3.x,vec3.y,vec3.z);
			} else if(type == "v4") {
				var vec4 = js.Boot.__cast(value , three.math.Vector4);
				this.gl.uniform4f(location,vec4.x,vec4.y,vec4.z,vec4.w);
			} else if(type == "c") {
				var color = js.Boot.__cast(value , three.math.Color);
				this.gl.uniform3f(location,color.r,color.g,color.b);
			} else if(type == "iv1") this.gl.uniform1iv(location,value); else if(type == "iv") this.gl.uniform3iv(location,value); else if(type == "fv1") this.gl.uniform1fv(location,value); else if(type == "fv") this.gl.uniform3fv(location,value); else if(type == "v2v") {
				var arr = value;
				if(uniform._array == null) uniform._array = new Float32Array(2 * arr.length);
				var _g3 = 0, _g2 = arr.length;
				while(_g3 < _g2) {
					var i = _g3++;
					offset = i * 2;
				...
				this.gl.uniform2fv(location,uniform._array);
			} else if(type == "v3v") {
				var arr = value;
				if(uniform._array == null) uniform._array = new Float32Array(3 * arr.length);
				var _g3 = 0, _g2 = arr.length;
				while(_g3 < _g2) {
					var i = _g3++;
					offset = i * 3;
				...
				this.gl.uniform3fv(location,uniform._array);
			} else if(type == "v4v") {
				var arr = value;
				if(uniform._array == null) uniform._array = new Float32Array(4 * arr.length);
				var _g3 = 0, _g2 = arr.length;
				while(_g3 < _g2) {
					var i = _g3++;
					offset = i * 4;
				...
				this.gl.uniform4fv(location,uniform._array);
			} else if(type == "m4") {
				if(uniform._array == null) uniform._array = new Float32Array(16);
				value.flattenToArray(uniform._array);
				this.gl.uniformMatrix4fv(location,false,uniform._array);
			} else if(type == "m4v") {
				var arr = value;
				if(uniform._array == null) uniform._array = new Float32Array(16 * arr.length);
				var _g3 = 0, _g2 = arr.length;
				while(_g3 < _g2) {
					var i = _g3++;
				...
				if(js.Boot.__instanceof(texture.image,Array) && texture.image.length == 6) this.setCubeTexture(texture,value); else if(js.Boot.__instanceof(texture,three.renderers.WebGLRenderTargetCube)) this.setCubeTextureDynamic(texture,value); else this.setTexture(texture,value);
			} else if(type == "tv") {
				if(uniform._array == null) {
					uniform._array = [];
					var _g3 = 0, _g2 = uniform.texture.length;
					while(_g3 < _g2) {
						var i = _g3++;
						uniform._array[i] = value + i;
					}
				}
				this.gl.uniform1iv(location,uniform._array);
				var _g3 = 0, _g2 = uniform.texture.length;
				while(_g3 < _g2) {
					var i = _g3++;
	...
	,loadUniformsMatrices: function(uniforms,object) {
		this.gl.uniformMatrix4fv(uniforms.modelViewMatrix,false,object._modelViewMatrix.elements);
		if(uniforms.normalMatrix != null) this.gl.uniformMatrix3fv(uniforms.normalMatrix,false,object._normalMatrix.elements);
	}
	,refreshUniformsShadow: function(uniforms,lights) {
		if(uniforms.shadowMatrix) {
			...
			while(_g1 < _g) {
				...
				if(js.Boot.__instanceof(light,three.lights.SpotLight) || js.Boot.__instanceof(light,three.lights.DirectionalLight) && !light.shadowCascade) {
	...
	,refreshUniformsLights: function(uniforms,lights) {
	...
	,refreshUniformsLambert: function(uniforms,material) {
		if(this.gammaInput) {
	...
	,refreshUniformsPhong: function(uniforms,material) {
	...
	,refreshUniformsFog: function(uniforms,fog) {
		uniforms.fogColor.value = fog.color;
		if(js.Boot.__instanceof(fog,three.scenes.Fog)) {
			var fog1 = js.Boot.__cast(fog , three.scenes.Fog);
			uniforms.fogNear.value = fog1.near;
			uniforms.fogFar.value = fog1.far;
		} else if(js.Boot.__instanceof(fog,three.scenes.FogExp2)) uniforms.fogDensity.value = (js.Boot.__cast(fog , three.scenes.FogExp2)).density;
	}
	,refreshUniformsParticle: function(uniforms,material) {
	...
	,refreshUniformsLine: function(uniforms,material) {
		uniforms.diffuse.value = material.color;
		uniforms.opacity.value = material.opacity;
	}
	,refreshUniformsCommon: function(uniforms,material) {
		uniforms.opacity.value = material.opacity;
		if(this.gammaInput) uniforms.diffuse.value.copyGammaToLinear(material.color); else uniforms.diffuse.value = material.color;
		uniforms.map.texture = material.map;
		...
		var uvScaleMap = null;
		if(material.map != null) uvScaleMap = material.map; else if(material.specularMap != null) uvScaleMap = material.specularMap; else if(material.bumpMap != null) uvScaleMap = material.bumpMap;
		if(uvScaleMap != null) {
		...
		uniforms.flipEnvMap.value = js.Boot.__instanceof(material.envMap,three.renderers.WebGLRenderTargetCube)?1:-1;
		if(this.gammaInput) uniforms.reflectivity.value = material.reflectivity; else uniforms.reflectivity.value = material.reflectivity;
		uniforms.refractionRatio.value = material.refractionRatio;
		uniforms.combine.value = material.combine;
		uniforms.useRefract.value = material.envMap != null && js.Boot.__instanceof(material.envMap.mapping,three.materials.CubeRefractionMapping);
	}
	,setupMatrices: function(object,camera) {
	...
	,initMaterial: function(material,lights,fog,object) {
		...
		var shaderID = "";
		if(js.Boot.__instanceof(material,three.materials.MeshDepthMaterial)) shaderID = "depth"; else if(js.Boot.__instanceof(material,three.materials.MeshNormalMaterial)) shaderID = "normal"; else if(js.Boot.__instanceof(material,three.materials.MeshBasicMaterial)) shaderID = "basic"; else if(js.Boot.__instanceof(material,three.materials.MeshLambertMaterial)) shaderID = "lambert"; else if(js.Boot.__instanceof(material,three.materials.MeshPhongMaterial)) shaderID = "phong"; else if(js.Boot.__instanceof(material,three.materials.LineBasicMaterial)) shaderID = "basic"; else if(js.Boot.__instanceof(material,three.materials.ParticleBasicMaterial)) shaderID = "particle_basic";
		if(shaderID != "") this.setMaterialShaders(material,three.renderers.ShaderLib.getShaderDef(shaderID));
		maxLightCount = this.allocateLights(lights);
		maxShadows = this.allocateShadows(lights);
		maxBones = this.allocateBones(object);
		parameters = { map : material.map, envMap : material.envMap, lightMap : material.lightMap, bumpMap : material.bumpMap, specularMap : material.specularMap, vertexColors : material.vertexColors, fog : fog, useFog : material.fog, sizeAttenuation : material.sizeAttenuation, skinning : material.skinning, maxBones : maxBones, useVertexTexture : this._supportsBoneTextures && object && object.useVertexTexture, boneTextureWidth : object && object.boneTextureWidth, boneTextureHeight : object && object.boneTextureHeight, morphTargets : material.morphTargets, morphNormals : material.morphNormals, maxMorphTargets : this.maxMorphTargets, maxMorphNormals : this.maxMorphNormals, maxDirLights : maxLightCount.directional, maxPointLights : maxLightCount.point, maxSpotLights : maxLightCount.spot, maxShadows : maxShadows, shadowMapEnabled : this.shadowMapEnabled && object.receiveShadow, shadowMapSoft : this.shadowMapSoft, shadowMapDebug : this.shadowMapDebug, shadowMapCascade : this.shadowMapCascade, alphaTest : material.alphaTest, metal : material.metal, perPixel : material.perPixel, wrapAround : material.wrapAround, doubleSided : material.side == 2};
		material.program = this.buildProgram(shaderID,material.fragmentShader,material.vertexShader,material.uniforms,material.attributes,parameters);
		var attributes = material.program.attributes;
		if(attributes.position >= 0) this.gl.enableVertexAttribArray(attributes.position);
		if(attributes.color >= 0) this.gl.enableVertexAttribArray(attributes.color);
		if(attributes.normal >= 0) this.gl.enableVertexAttribArray(attributes.normal);
		if(attributes.tangent >= 0) this.gl.enableVertexAttribArray(attributes.tangent);
		if(material.skinning && attributes.skinVertexA >= 0 && attributes.skinVertexB >= 0 && attributes.skinIndex >= 0 && attributes.skinWeight >= 0) {
			this.gl.enableVertexAttribArray(attributes.skinVertexA);
			this.gl.enableVertexAttribArray(attributes.skinVertexB);
			this.gl.enableVertexAttribArray(attributes.skinIndex);
			this.gl.enableVertexAttribArray(attributes.skinWeight);
		}
		if(material.attributes != null) {
			var fields = Type.getClassFields(material.attributes);
			var _g = 0;
			while(_g < fields.length) {
				var a1 = fields[_g];
				++_g;
				if(attributes[a1] != null && attributes[a1] >= 0) this.gl.enableVertexAttribArray(attributes[a1]);
			}
		}
		if(material.morphTargets) {
			...
			var _g1 = 0, _g = this.maxMorphTargets;
			while(_g1 < _g) {
				var i1 = _g1++;
				id = base + i1;
				if(attributes[id] >= 0) {
					this.gl.enableVertexAttribArray(attributes[id]);
		...
		if(material.morphNormals) {
			...
			var _g1 = 0, _g = this.maxMorphNormals;
			while(_g1 < _g) {
				var i1 = _g1++;
				id = base + i1;
				if(attributes[id] >= 0) {
		...
		var fields = Type.getClassFields(material.uniforms);
		var _g = 0;
		while(_g < fields.length) {
			var u1 = fields[_g];
			++_g;
			material.uniformsList.push([material.uniforms[u1],u1]);
		}
	}
	,setTexture: function(texture,slot) {
		if(texture.needsUpdate) {
			if(!texture.__webglInit) {
				...
				texture.__webglTexture = this.gl.createTexture();
				this.info.memory.textures++;
			}
			this.gl.activeTexture(this.gl.TEXTURE0 + slot);
			this.gl.bindTexture(this.gl.TEXTURE_2D,texture.__webglTexture);
			this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,texture.flipY?1:0);
			this.gl.pixelStorei(this.gl.UNPACK_PREMULTIPLY_ALPHA_WEBGL,texture.premultiplyAlpha?1:0);
			var image = texture.image, isImagePowerOfTwo = three.math.MathUtil.isPowerOfTwo(image.width) && three.math.MathUtil.isPowerOfTwo(image.height), glFormat = three.ThreeGlobal.paramThreeToGL(texture.format), glType = three.ThreeGlobal.paramThreeToGL(texture.type);
			this.setTextureParameters(this.gl.TEXTURE_2D,texture,isImagePowerOfTwo);
			if(js.Boot.__instanceof(texture,three.textures.DataTexture)) this.gl.texImage2D(this.gl.TEXTURE_2D,0,glFormat,image.width,image.height,0,glFormat,glType,image.data); else this.gl.texImage2D(this.gl.TEXTURE_2D,0,glFormat,glFormat,glType,texture.image);
			if(texture.generateMipmaps && isImagePowerOfTwo) this.gl.generateMipmap(this.gl.TEXTURE_2D);
			texture.needsUpdate = false;
			if($bind(texture,texture.onUpdate) != null) texture.onUpdate();
		} else {
			this.gl.activeTexture(this.gl.TEXTURE0 + slot);
			this.gl.bindTexture(this.gl.TEXTURE_2D,texture.__webglTexture);
		}
	...
	,setCubeTextureDynamic: function(texture,slot) {
		this.gl.activeTexture(this.gl.TEXTURE0 + slot);
		this.gl.bindTexture(this.gl.TEXTURE_CUBE_MAP,texture.__webglTexture);
	}
	,setCubeTexture: function(texture,slot) {
		if(texture.image.length == 6) {
			if(texture.needsUpdate) {
				if(!texture.image.__webglTextureCube) texture.image.__webglTextureCube = this.gl.createTexture();
				this.gl.activeTexture(this.gl.TEXTURE0 + slot);
				this.gl.bindTexture(this.gl.TEXTURE_CUBE_MAP,texture.image.__webglTextureCube);
				this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,texture.flipY?1:0);
				var cubeImage = [];
				var _g = 0;
				while(_g < 6) {
					var i = _g++;
					if(this.autoScaleCubemaps) cubeImage[i] = this.clampToMaxSize(texture.image[i],this._maxCubemapSize); else cubeImage[i] = texture.image[i];
				}
				var image = cubeImage[0], isImagePowerOfTwo = three.math.MathUtil.isPowerOfTwo(image.width) && three.math.MathUtil.isPowerOfTwo(image.height), glFormat = three.ThreeGlobal.paramThreeToGL(texture.format), glType = three.ThreeGlobal.paramThreeToGL(texture.type);
				this.setTextureParameters(this.gl.TEXTURE_CUBE_MAP,texture,isImagePowerOfTwo);
				var _g = 0;
				while(_g < 6) {
					var i = _g++;
					this.gl.texImage2D(this.gl.TEXTURE_CUBE_MAP_POSITIVE_X + i,0,glFormat,glFormat,glType,cubeImage[i]);
				}
				if(texture.generateMipmaps && isImagePowerOfTwo) this.gl.generateMipmap(this.gl.TEXTURE_CUBE_MAP);
				texture.needsUpdate = false;
				if($bind(texture,texture.onUpdate) != null) texture.onUpdate();
			} else {
				this.gl.activeTexture(this.gl.TEXTURE0 + slot);
	...
	,clampToMaxSize: function(image,maxSize) {
		if(image.width <= maxSize && image.height <= maxSize) return image;
		var maxDimension = Math.max(image.width,image.height);
		var newWidth = Math.floor(image.width * maxSize / maxDimension);
		var newHeight = Math.floor(image.height * maxSize / maxDimension);
		var canvas = js.Boot.__cast(js.Lib.document.createElement("canvas") , js.w3c.html5.HTMLCanvasElement);
		canvas.width = newWidth;
		canvas.height = newHeight;
		var ctx = js.Boot.__cast(canvas.getContext("2d") , js.w3c.html5.CanvasRenderingContext2D);
	...
	,setClearColor: function(color) {
		this._clearColor.setRGBA(color);
	...
	,supportsVertexTextures: function() {
		return this._supportsVertexTextures;
	}
	...
	,initGL: function() {
		...
		this._glExtensionTextureFloat = js.Boot.__cast(this.gl.getExtension("OES_texture_float") , Bool);
		this._glExtensionStandardDerivatives = js.Boot.__cast(this.gl.getExtension("OES_standard_derivatives") , Bool);
		if(this.gl.getExtension("EXT_texture_filter_anisotropic") != null) this._glExtensionTextureFilterAnisotropic = this.gl.getExtension("EXT_texture_filter_anisotropic"); else if(this.gl.getExtension("MOZ_EXT_texture_filter_anisotropic") != null) this._glExtensionTextureFilterAnisotropic = this.gl.getExtension("MOZ_EXT_texture_filter_anisotropic"); else if(this.gl.getExtension("MOZ_EXT_texture_filter_anisotropic") != null) this._glExtensionTextureFilterAnisotropic = this.gl.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
		if(!this._glExtensionTextureFloat) three.utils.Logger.log("WebGLRenderer: Float textures not supported.");
		if(!this._glExtensionStandardDerivatives) three.utils.Logger.log("WebGLRenderer: Standard derivatives not supported.");
		if(!this._glExtensionTextureFilterAnisotropic) three.utils.Logger.log("WebGLRenderer: Anisotropic texture filtering not supported.");
	}
	...
	,setProgram: function(camera,lights,fog,material,object) {
		if(material.needsUpdate) {
			if(material.program != null) this.deallocateMaterial(material);
			this.initMaterial(material,lights,fog,object);
			material.needsUpdate = false;
		}
		if(material.morphTargets != null) {
			if(object.__webglMorphTargetInfluences == null) object.__webglMorphTargetInfluences = new Float32Array(this.maxMorphTargets);
		}
		...
		if(refreshMaterial || camera != this._currentCamera) {
			this.gl.uniformMatrix4fv(p_uniforms.projectionMatrix,false,camera._projectionMatrixArray);
			if(camera != this._currentCamera) this._currentCamera = camera;
		}
		if(refreshMaterial) {
			if(fog != null && material.fog != null) this.refreshUniformsFog(m_uniforms,fog);
			if(js.Boot.__instanceof(material,three.materials.MeshPhongMaterial) || js.Boot.__instanceof(material,three.materials.MeshLambertMaterial) || material.lights != null) {
			...
			if(js.Boot.__instanceof(material,three.materials.MeshBasicMaterial) || js.Boot.__instanceof(material,three.materials.MeshLambertMaterial) || js.Boot.__instanceof(material,three.materials.MeshPhongMaterial)) this.refreshUniformsCommon(m_uniforms,material);
			if(js.Boot.__instanceof(material,three.materials.LineBasicMaterial)) this.refreshUniformsLine(m_uniforms,material); else if(js.Boot.__instanceof(material,three.materials.ParticleBasicMaterial)) this.refreshUniformsParticle(m_uniforms,material); else if(js.Boot.__instanceof(material,three.materials.MeshPhongMaterial)) this.refreshUniformsPhong(m_uniforms,material); else if(js.Boot.__instanceof(material,three.materials.MeshLambertMaterial)) this.refreshUniformsLambert(m_uniforms,material); else if(js.Boot.__instanceof(material,three.materials.MeshDepthMaterial)) {
				m_uniforms.mNear.value = camera.near;
				m_uniforms.mFar.value = camera.far;
				m_uniforms.opacity.value = material.opacity;
			} else if(js.Boot.__instanceof(material,three.materials.MeshNormalMaterial)) m_uniforms.opacity.value = material.opacity;
			if(object.receiveShadow && !material._shadowPass) this.refreshUniformsShadow(m_uniforms,lights);
			this.loadUniformsGeneric(program,material.uniformsList);
			if(js.Boot.__instanceof(material,three.materials.ShaderMaterial) || js.Boot.__instanceof(material,three.materials.MeshPhongMaterial) || material.envMap != null) {
				if(p_uniforms.cameraPosition != null) {
					var position = camera.matrixWorld.getPosition();
					this.gl.uniform3f(p_uniforms.cameraPosition,position.x,position.y,position.z);
				}
			}
			if(js.Boot.__instanceof(material,three.materials.MeshPhongMaterial) || js.Boot.__instanceof(material,three.materials.MeshLambertMaterial) || js.Boot.__instanceof(material,three.materials.ShaderMaterial) || material.skinning) {
				if(p_uniforms.viewMatrix != null) this.gl.uniformMatrix4fv(p_uniforms.viewMatrix,false,camera._viewMatrixArray);
			}
		}
		if(material.skinning) {
			if(this._supportsBoneTextures && object.useVertexTexture) {
				if(p_uniforms.boneTexture != null) {
					var textureUnit = 12;
					this.gl.uniform1i(p_uniforms.boneTexture,textureUnit);
					this.setTexture(object.boneTexture,textureUnit);
				}
			} else if(p_uniforms.boneGlobalMatrices != null) this.gl.uniformMatrix4fv(p_uniforms.boneGlobalMatrices,false,object.boneMatrices);
		}
		this.loadUniformsMatrices(p_uniforms,object);
		if(p_uniforms.modelMatrix != null) this.gl.uniformMatrix4fv(p_uniforms.modelMatrix,false,object.matrixWorld.elements);
		return program;
	}
	,setMaterialShaders: function(material,shaders) {
		material.uniforms = three.renderers.UniformsUtils.clone(shaders.uniforms);
	...
	,renderPlugins: function(plugins,scene,camera) {
		if(plugins.length == 0) return;
		var _g1 = 0, _g = plugins.length;
		while(_g1 < _g) {
			var i = _g1++;
			this._currentProgram = null;
			...
			this._currentMaterialId = -1;
			this._lightsNeedUpdate = true;
			plugins[i].render(scene,camera,this._currentWidth,this._currentHeight);
			this._currentProgram = null;
			this._currentCamera = null;
			this._oldBlending = -1;
			this._oldDepthTest = false;
	...
	,_currentCamera: null
	,_supportsBoneTextures: null
	,_supportsVertexTextures: null
	,_maxAnisotropy: null
	,_maxCubemapSize: null
	,_maxTextureSize: null
	,_maxVertexTextures: null
	...
	,_direction: null
	,_vector3: null
	,_projScreenMatrixPS: null
	,_projScreenMatrix: null
	,_frustum: null
	,_maxLights: null
	,_preserveDrawingBuffer: null
	,_stencil: null
	,_antialias: null
...
three.renderers.plugins.LensFlarePlugin.prototype = {
	render: function(scene,camera,width,height) {
	}
...
$hxClasses["three.scenes.IFog"] = three.scenes.IFog;
three.scenes.IFog.__name__ = ["three","scenes","IFog"];
...
three.scenes.Fog.__interfaces__ = [three.scenes.IFog];
...
three.scenes.FogExp2 = function(hex,density) {
	if(density == null) density = 0.00025;
	this.color = new three.math.Color(hex);
	this.density = density;
};
$hxClasses["three.scenes.FogExp2"] = three.scenes.FogExp2;
three.scenes.FogExp2.__name__ = ["three","scenes","FogExp2"];
three.scenes.FogExp2.__interfaces__ = [three.scenes.IFog];
three.scenes.FogExp2.prototype = {
	density: null
	,color: null
	,__class__: three.scenes.FogExp2
}
...
three.utils.BoolUtil = function() { }
$hxClasses["three.utils.BoolUtil"] = three.utils.BoolUtil;
three.utils.BoolUtil.__name__ = ["three","utils","BoolUtil"];
three.utils.BoolUtil.toInt = function(value) {
	return value?1:0;
}
...
three.renderers.WebGLRenderer._programs_counter = 0;
