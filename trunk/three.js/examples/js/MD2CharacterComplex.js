...
THREE.MD2CharacterComplex = function () {
	...
	this.updateMovementModel = function ( delta ) {
		...
		if ( controls.moveForward )  this.speed = THREE.MathUtil.clamp( this.speed + delta * this.frontAcceleration, this.maxReverseSpeed, this.maxSpeed );
		if ( controls.moveBackward ) this.speed = THREE.MathUtil.clamp( this.speed - delta * this.backAcceleration, this.maxReverseSpeed, this.maxSpeed );
		...
		if ( controls.moveLeft ) {
			...
			this.speed = THREE.MathUtil.clamp( this.speed + dir * delta * this.frontAcceleration, this.maxReverseSpeed, this.maxSpeed );
		...
		if ( ! ( controls.moveForward || controls.moveBackward ) ) {
			...
			if ( this.speed > 0 ) {
				...
				this.speed = THREE.MathUtil.clamp( this.speed - k * delta * this.frontDecceleration, 0, this.maxSpeed );

			} else {

				var k = exponentialEaseOut( this.speed / this.maxReverseSpeed );
				this.speed = THREE.MathUtil.clamp( this.speed + k * delta * this.backAcceleration, this.maxReverseSpeed, 0 );
