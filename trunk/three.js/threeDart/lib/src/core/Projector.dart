  ...
  ProjectorRenderData projectGraph( Object3D root, bool sort ) {
    ...
    projectObject = ( Object3D object ) {
      ...
      if ( ( object is Mesh || object is Line ) &&
          ( identical(object.frustumCulled, false) || _frustum.contains( object ) ) ) {
    ...
    _renderData.objects.forEach((o) {
      ...
      if ( object is Mesh ) {
        ...
        for ( f = 0; f < fl; f ++ ) {
          ...
          material = identical(isFaceMaterial, true) ? geometryMaterials[ face.materialIndex ] : object.material;
          ...
          if ( face is Face3 ) {
            ...
            if ( v1.visible && v2.visible && v3.visible ) {
              ...
              if ( identical(side, Three.DoubleSide) || identical(visible, ( identical(side, Three.FrontSide) )) ) {
          ...
          _face.normalWorld.copy( face.normal );
		      ...
		      if ( identical(visible, false) && ( identical(side, Three.BackSide) || identical(side, Three.DoubleSide) ) ) _face.normalWorld.negate();
      ...
      // Handle LineStrip and LinePieces
        var step = identical(object.type, Three.LinePieces) ? 2 : 1;
