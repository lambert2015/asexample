...
class TestPhongPointLight extends SimpleApplication
{
	...
	override private function initialize():Void
	{
		...
		material.setShader(new PhongPointLighting());
		...
		colorMat.setColor(light.getColor().getColor());
	...
	{
		Lib.current.addChild(new TestPhongPointLight());
	}
}
