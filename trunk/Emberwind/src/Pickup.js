...
function Pickup(t, table) {
	if (t === undefined) {
		t = Pickup.Type.kPickupMaxType;
	}
	if (table === undefined) {
		table = DropTableType.kMaxDT;
	}
...
Pickup.prototype.init = function(reinit) {
	...
	this.pickupVolume = new TriggerVolume("pickup", new Rectf(-20, -40, 20, 0), this, createCallback(this.onTrigger, this), "pickup");
...
Pickup.prototype.getIdleAnimation = function() {
	...
	return {
		idleAnim : depot.getAnimation(Pickup.kTypeImage[this.type]),
		play : true,
		random : false
	};
};
