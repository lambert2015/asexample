...
InputHandler.prototype.setInput = function(canvas) {
	...
	if (this.useTouch) {
		...
		// Keyboard
		var blockList = [27, 32, 37, 38, 39, 40];
...
/**
 * A isosceles triangle described as a point in the angle between the isosceles
 * sides and base direction is facing to positive y.
 *
 ...
 * @param directionAngle the angle in degrees of the whole triangle in steps of
 * 90.
