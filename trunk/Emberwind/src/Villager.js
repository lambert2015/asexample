function Villager() {
	...
	var states = [Villager.states.kStateHappy, new SimpleState(Villager.states.kStateHappy, createCallback(this.happyEnter, this), createCallback(this.happyLeave, this), createCallback(this.happyUpdate, this)), Villager.states.kStatePanic, new SimpleState(Villager.states.kStatePanic, createCallback(this.panicEnter, this), null, createCallback(this.panicUpdate, this)), Villager.states.kStateScared, new SimpleState(Villager.states.kStateScared, createCallback(this.scaredEnter, this), null, null)];
