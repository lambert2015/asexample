function Wick() {
	...
	this.states = [Wick.states.kStateEnterStage, WickEnterStageState, Wick.states.kStateLand, WickLandState, Wick.states.kStateIdle, WickIdleState, Wick.states.kStateExitStage, WickExitStageState];
