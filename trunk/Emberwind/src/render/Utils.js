...
utils.resolveShaders = function(shaders, document) {
	if (shaders == null) {
		...
		shaders = ["no-texture-vs", "gradient-vs", "texture-vs", "caching-vs", "layer-vs", "no-texture-fs", "gradient-fs", "alpha-fs", "tint-fs", "caching-fs", "alpha-padding-fs", "tint-padding-fs", "layer-fs"];
	} else {
