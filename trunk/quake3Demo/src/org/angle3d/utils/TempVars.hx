...
class TempVars 
{
	...
	public function new() 
	{
		...
		fWdU    = new Vector<Float>(3, true);
        fAWdU   = new Vector<Float>(3, true);
        fDdU    = new Vector<Float>(3, true);
        fADdU   = new Vector<Float>(3, true);
        fAWxDdU = new Vector<Float>(3, true);
	}
