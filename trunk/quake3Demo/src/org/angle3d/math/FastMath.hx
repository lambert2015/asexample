...
class FastMath
{
	...
	public static var ONE_THIRD = 1.0 / 3.0;
	
	public static var FLT_EPSILON: Float = 1.1920928955078125E-7;
	/** A "close to zero" float epsilon value for use*/
	public static var ZERO_TOLERANCE: Float = 0.0001;
	...
	*/
    ...
    public static inline function interpolateLinear(scale:Float,startValue:Float,endValue:Float):Float
	{
		...
		{
			return ((1 - scale) * startValue) + (scale * endValue);
		}
    }
