package org.angle3d.input
{
	...
	public class FlyByCamera implements AnalogListener, ActionListener
	{
		...
		public function registerWithInput(inputManager:InputManager):void
		{
			...
			inputManager.addMapping("FLYCAM_Left", Vector.<Trigger>([new MouseAxisTrigger(MouseInput.AXIS_X, true), new KeyTrigger(Keyboard.LEFT)]));

			inputManager.addMapping("FLYCAM_Right", Vector.<Trigger>([new MouseAxisTrigger(MouseInput.AXIS_X, false), new KeyTrigger(Keyboard.RIGHT)]));

			inputManager.addMapping("FLYCAM_Up", Vector.<Trigger>([new MouseAxisTrigger(MouseInput.AXIS_Y, false), new KeyTrigger(Keyboard.UP)]));

			inputManager.addMapping("FLYCAM_Down", Vector.<Trigger>([new MouseAxisTrigger(MouseInput.AXIS_Y, true), new KeyTrigger(Keyboard.DOWN)]));
