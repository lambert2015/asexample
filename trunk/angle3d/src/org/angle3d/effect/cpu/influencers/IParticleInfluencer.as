package org.angle3d.effect.cpu.influencers
{
	...
	/**
	 * An public interface that defines the methods to affect initial velocity of the particles.
	 * 用于影响粒子初次的速度
	 */
	public interface IParticleInfluencer
	{
		/**
		 ...
		 */
		function setVelocityVariation(variation:Number):void;

		/**
		 * This method returns the velocity variation.
		 * @return the velocity variation
		 */
		function getVelocityVariation():Number;
