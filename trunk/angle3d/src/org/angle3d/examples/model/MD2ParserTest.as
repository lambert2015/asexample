package org.angle3d.examples.model
{
	...
	import org.angle3d.examples.skybox.DefaultSkyBox;
	...
	public class MD2ParserTest extends SimpleApplication
	{
		...
		private var animations : Array = ["stand", "run",
			"attack", "pain",
			"jump", "flip",
			"salute", "taunt",
			"wave", "point", "crwalk",
		...
		private function _loadComplete(signal : LoaderSignal, assets : Dictionary) : void
		{
			...
			var reflectiveMat : MaterialReflective = new MaterialReflective(new BitmapTexture(assets["ratamahatta_texture"].bitmapData),
				skybox.cubeMap, 0.9);
