...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(18)
		::nme::Lib_obj::setPackage(HX_CSTRING("NME"),HX_CSTRING("NMEQuake3"),HX_CSTRING("NMEQuake3"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(42)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int(::nme::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("NMEQuake3"),null(),null());
	}
return null();
}
