...
::native::text::TextLineMetrics_obj::__register();
...
::native::text::GridFitType_obj::__register();
...
::native::filters::GlowFilter_obj::__register();
::native::filters::DropShadowFilter_obj::__register();
::native::filters::BlurFilter_obj::__register();
...
::native::display::SimpleButton_obj::__register();
...
::format::swf::symbol::Symbol_obj::__register();
::format::swf::symbol::StaticText_obj::__register();
::format::swf::symbol::Sprite_obj::__register();
::format::swf::symbol::ShapeEdge_obj::__register();
::format::swf::symbol::Shape_obj::__register();
::format::swf::symbol::MorphEdge_obj::__register();
::format::swf::symbol::MorphShape_obj::__register();
::format::swf::symbol::Font_obj::__register();
::format::swf::symbol::EditText_obj::__register();
::format::swf::symbol::ButtonState_obj::__register();
::format::swf::symbol::ButtonRecord_obj::__register();
::format::swf::symbol::Button_obj::__register();
::format::swf::symbol::Bitmap_obj::__register();
::format::swf::data::Tags_obj::__register();
::format::swf::data::SWFStream_obj::__register();
::format::swf::data::Frame_obj::__register();
::format::swf::data::Filters_obj::__register();
::format::swf::data::DisplayAttributes_obj::__register();
::format::swf::data::DepthSlot_obj::__register();
::format::swf::MovieClip_obj::__register();
::format::swf::MorphObject_obj::__register();
::format::display::MovieClip_obj::__register();
::format::display::FrameLabel_obj::__register();
::format::SWF_obj::__register();
...
::format::SWF_obj::__boot();
::format::display::FrameLabel_obj::__boot();
::format::display::MovieClip_obj::__boot();
::format::swf::MorphObject_obj::__boot();
::format::swf::MovieClip_obj::__boot();
::format::swf::data::DepthSlot_obj::__boot();
::format::swf::data::DisplayAttributes_obj::__boot();
::format::swf::data::Filters_obj::__boot();
::format::swf::data::Frame_obj::__boot();
::format::swf::data::SWFStream_obj::__boot();
::format::swf::data::Tags_obj::__boot();
::format::swf::symbol::Bitmap_obj::__boot();
::format::swf::symbol::Button_obj::__boot();
::format::swf::symbol::ButtonRecord_obj::__boot();
::format::swf::symbol::ButtonState_obj::__boot();
::format::swf::symbol::EditText_obj::__boot();
::format::swf::symbol::Font_obj::__boot();
::format::swf::symbol::MorphShape_obj::__boot();
::format::swf::symbol::MorphEdge_obj::__boot();
::format::swf::symbol::Shape_obj::__boot();
::format::swf::symbol::ShapeEdge_obj::__boot();
::format::swf::symbol::Sprite_obj::__boot();
::format::swf::symbol::StaticText_obj::__boot();
::format::swf::symbol::Symbol_obj::__boot();
...
::native::display::SimpleButton_obj::__boot();
...
::native::filters::BlurFilter_obj::__boot();
::native::filters::DropShadowFilter_obj::__boot();
::native::filters::GlowFilter_obj::__boot();
...
::native::text::GridFitType_obj::__boot();
...
::native::text::TextLineMetrics_obj::__boot();
