...
::native::text::GridFitType GridFitType_obj::NONE;

::native::text::GridFitType GridFitType_obj::PIXEL;

::native::text::GridFitType GridFitType_obj::SUBPIXEL;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.GridFitType"), hx::TCanCast< GridFitType_obj >,sStaticFields,sMemberFields,
	&__Create_GridFitType_obj, &__Create,
	&super::__SGetClass(), &CreateGridFitType_obj, sMarkStatics, sVisitStatic);
}
