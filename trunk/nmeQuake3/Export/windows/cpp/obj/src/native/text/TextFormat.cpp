...
{
HX_STACK_PUSH("TextFormat::new","native/text/TextFormat.hx",27);
{
	HX_STACK_LINE(28)
	this->font = in_font;
	HX_STACK_LINE(29)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.TextFormat"), hx::TCanCast< TextFormat_obj> ,sStaticFields,sMemberFields,
