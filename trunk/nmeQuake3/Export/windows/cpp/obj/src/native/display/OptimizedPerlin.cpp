...
{
HX_STACK_PUSH("OptimizedPerlin::new","native/display/BitmapData.hx",722);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","native/display/BitmapData.hx",861);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","native/display/BitmapData.hx",841);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","native/display/BitmapData.hx",729);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","native/display/BitmapData.hx",789);
										{
											HX_STACK_LINE(789)
