...
void TextFormatAlign_obj::__Visit(HX_VISIT_PARAMS)
{
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.text.TextFormatAlign"), hx::TCanCast< TextFormatAlign_obj> ,sStaticFields,sMemberFields,
