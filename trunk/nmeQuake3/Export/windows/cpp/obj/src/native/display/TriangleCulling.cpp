...
::native::display::TriangleCulling TriangleCulling_obj::NEGATIVE;

::native::display::TriangleCulling TriangleCulling_obj::NONE;

::native::display::TriangleCulling TriangleCulling_obj::POSITIVE;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.TriangleCulling"), hx::TCanCast< TriangleCulling_obj >,sStaticFields,sMemberFields,
