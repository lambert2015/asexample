...
{
HX_STACK_PUSH("IntMap::new","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",28);
{
	HX_STACK_LINE(28)
...
Dynamic IntMap_obj::keys( ){
	HX_STACK_PUSH("IntMap::keys","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",48);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
...
bool IntMap_obj::remove( int key){
	HX_STACK_PUSH("IntMap::remove","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",44);
	HX_STACK_THIS(this);
...
bool IntMap_obj::exists( int key){
	HX_STACK_PUSH("IntMap::exists","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",40);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(40)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_PUSH("IntMap::get","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_ARG(key,"key");
	HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("IntMap::set","C:\\HaxeFoundation\\haxe/std/cpp/_std/haxe/ds/IntMap.hx",32);
		HX_STACK_THIS(this);
		HX_STACK_ARG(key,"key");
