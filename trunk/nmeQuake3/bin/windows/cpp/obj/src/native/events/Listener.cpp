...
{
HX_STACK_PUSH("Listener::new","native/events/EventDispatcher.hx",156);
{
	HX_STACK_LINE(157)
...
bool Listener_obj::Is( Dynamic inListener,bool inCapture){
	HX_STACK_PUSH("Listener::Is","native/events/EventDispatcher.hx",169);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Listener::dispatchEvent","native/events/EventDispatcher.hx",164);
		HX_STACK_THIS(this);
