...
::native::display::StageAlign StageAlign_obj::BOTTOM;

::native::display::StageAlign StageAlign_obj::BOTTOM_LEFT;

::native::display::StageAlign StageAlign_obj::BOTTOM_RIGHT;

::native::display::StageAlign StageAlign_obj::LEFT;

::native::display::StageAlign StageAlign_obj::RIGHT;

::native::display::StageAlign StageAlign_obj::TOP;

::native::display::StageAlign StageAlign_obj::TOP_LEFT;

::native::display::StageAlign StageAlign_obj::TOP_RIGHT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.StageAlign"), hx::TCanCast< StageAlign_obj >,sStaticFields,sMemberFields,
	&__Create_StageAlign_obj, &__Create,
	&super::__SGetClass(), &CreateStageAlign_obj, sMarkStatics, sVisitStatic);
}
