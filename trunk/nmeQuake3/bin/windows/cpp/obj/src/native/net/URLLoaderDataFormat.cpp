...
::native::net::URLLoaderDataFormat URLLoaderDataFormat_obj::BINARY;

::native::net::URLLoaderDataFormat URLLoaderDataFormat_obj::TEXT;

::native::net::URLLoaderDataFormat URLLoaderDataFormat_obj::VARIABLES;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.net.URLLoaderDataFormat"), hx::TCanCast< URLLoaderDataFormat_obj >,sStaticFields,sMemberFields,
