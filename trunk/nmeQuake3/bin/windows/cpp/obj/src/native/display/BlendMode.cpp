...
::native::display::BlendMode BlendMode_obj::ADD;

::native::display::BlendMode BlendMode_obj::ALPHA;

::native::display::BlendMode BlendMode_obj::DARKEN;

::native::display::BlendMode BlendMode_obj::DIFFERENCE;

::native::display::BlendMode BlendMode_obj::ERASE;

::native::display::BlendMode BlendMode_obj::HARDLIGHT;

::native::display::BlendMode BlendMode_obj::INVERT;

::native::display::BlendMode BlendMode_obj::LAYER;

::native::display::BlendMode BlendMode_obj::LIGHTEN;

::native::display::BlendMode BlendMode_obj::MULTIPLY;

::native::display::BlendMode BlendMode_obj::NORMAL;

::native::display::BlendMode BlendMode_obj::OVERLAY;

::native::display::BlendMode BlendMode_obj::SCREEN;

::native::display::BlendMode BlendMode_obj::SUBTRACT;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.display.BlendMode"), hx::TCanCast< BlendMode_obj >,sStaticFields,sMemberFields,
