package org.angle3d.effect.cpu.influencers
{
	 ...
	 */
	public class DefaultParticleInfluencer implements IParticleInfluencer
	{
		/**
		 * Temporary variable used to help with calculations.
		 */
		protected var temp:Vector3f;
		/**
		 * The initial velocity of the particles.
		 */
		protected var initialVelocity:Vector3f;
		/**
		 * The velocity's variation of the particles.
		 */
		protected var velocityVariation:Number;
		 ...
		 */
		protected function applyVelocityVariation(particle:Particle):void
		{
