package org.angle3d.shadow
{
	...
	{
		public static function updateFrustumPoints2(viewCam:Camera3D,
		...
		public static function updateFrustumPoints(viewCam:Camera3D,
			nearOverride:Number,
			farOverride:Number,
			scale:Number,
			points:Vector.<Vector3f>):void
		 ...
		 * 
		 */		
		public static function updateShadowCamera(occluders:GeometryList,
			receivers:GeometryList,
			shadowCam:Camera3D,
			points:Vector.<Vector3f>,
			splitOccluders:GeometryList = null):void
		{
			var ortho:Boolean = shadowCam.parallelProjection;
			shadowCam.setProjectionMatrix(null);
