package org.assetloader.base
{
	...
	public class AssetLoaderBase extends AbstractLoader
	{
		 ...
		 * @private
		 */
		protected var _assetMap:Dictionary;
		/**
		 * @private
		 */
		 ...
		 * @param id  文件标识
		 * @param url 文件地址
		 * @param type 文件类型AssetType，默认根据后缀名判断
		 * @param params
		 * @return
		 *
		 */
		...
		{
			return _loaderMap.hasOwnProperty(id);
		}
		...
		{
			return (_loaderMap.hasOwnProperty(id) && _loaderMap[id] is IAssetLoader);
		}
		...
		{
			return _assetMap.hasOwnProperty(id);
		}
