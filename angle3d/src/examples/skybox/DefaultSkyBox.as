package examples.skybox
{
	...
	{
		[Embed(source = "../../../assets/embed/sky/negativeX.png")]
		private static var EmbedNegativeX : Class;

		[Embed(source = "../../../assets/embed/sky/negativeY.png")]
		private static var EmbedNegativeY : Class;

		[Embed(source = "../../../assets/embed/sky/negativeZ.png")]
		private static var EmbedNegativeZ : Class;

		[Embed(source = "../../../assets/embed/sky/positiveX.png")]
		private static var EmbedPositiveX : Class;

		[Embed(source = "../../../assets/embed/sky/positiveY.png")]
		private static var EmbedPositiveY : Class;

		[Embed(source = "../../../assets/embed/sky/positiveZ.png")]
