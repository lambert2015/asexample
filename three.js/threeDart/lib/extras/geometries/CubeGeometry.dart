...
class CubeGeometry extends Geometry {
  ...
  void buildPlane( String u, String v, num udir, num vdir, num width, num height, num depth, num material ) {
    ...
    if ( ( identical(u, 'x') && identical(v, 'y') ) || ( identical(u, 'y') && identical(v, 'x') ) ) {
      w = 'z';
    } else if ( ( identical(u, 'x') && identical(v, 'z') ) || ( identical(u, 'z') && identical(v, 'x') ) ) {
      w = 'y';
      gridY = ( segmentsDepth != null ) ? segmentsDepth : 1;
    } else if ( ( identical(u, 'z') && identical(v, 'y') ) || ( identical(u, 'y') && identical(v, 'z') ) ) {
      w = 'x';
