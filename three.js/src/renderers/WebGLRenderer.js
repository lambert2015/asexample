...
THREE.WebGLRenderer = function(parameters) {
	...
	var _precision = parameters.precision !== undefined ? parameters.precision : 'highp';

	var _alpha = parameters.alpha !== undefined ? parameters.alpha : true;
	...
	var _clearColor = parameters.clearColor !== undefined ? new THREE.Color(parameters.clearColor) : new THREE.Color(0x000000);
	var _clearAlpha = parameters.clearAlpha !== undefined ? parameters.clearAlpha : 0;

	var _maxLights = parameters.maxLights !== undefined ? parameters.maxLights : 4;
	...
	var _this = this, _programs = [], _programs_counter = 0,
	...
	_projScreenMatrix = new THREE.Matrix4(), _projScreenMatrixPS = new THREE.Matrix4(), _vector3 = new THREE.Vector4(),
	...
	var _maxVertexTextures = _gl.getParameter(_gl.MAX_VERTEX_TEXTURE_IMAGE_UNITS), _maxTextureSize = _gl.getParameter(_gl.MAX_TEXTURE_SIZE), _maxCubemapSize = _gl.getParameter(_gl.MAX_CUBE_MAP_TEXTURE_SIZE);
	...
	function loadUniformsGeneric(program, uniforms) {
		...
		for ( j = 0, jl = uniforms.length; j < jl; j++) {
			...
			} else if (type === "iv") {// flat array of integers with 3 x N size (JS or typed
				// array)
			...
			} else if (type === "fv") {// flat array of floats with 3 x N size (JS or typed
				// array)
