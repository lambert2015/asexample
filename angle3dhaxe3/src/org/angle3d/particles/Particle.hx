package org.angle3d.particles
{
	...
	class Particle implements IParticle
	{
		...
		*/
		 ...
		 */
		protected var mMarkedForEmission:Bool;
		 ...
		 */
		protected var mEnabled:Bool;

		/**
		 * Determines whether a particle is 'freezed'. This means that the particle doesnt move anymore.
		 */
		protected var mFreezed:Bool;

		/**
		 * Original setting.
		 */
		protected var mOriginalEnabled:Bool;

		/**
		 * Original may be set only once.
		 */
		protected var mOriginalEnabledSet:Bool;
