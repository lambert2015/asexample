package org.angle3d.material
{
	...
	class MaterialTexture extends Material
	{
		...
		public function MaterialTexture(texture:TextureMapBase, lightmap:TextureMapBase = null, useTexCoord2:Bool = false)
		{
			super();
		...
		override public function set skinningMatrices(data:Vector<Float>):Void
		{
		...
		public function set useTexCoord2(value:Bool):Void
		{
