package org.angle3d.scene.mesh
{
	...
	public class MeshHelper
	{
		...
		{
			var normals:Vector<Float> = new Vector<Float>(vertices.length, true);
		...
		{
			var iLength:Int = indices.length;
			var faceNormals:Vector<Float> = new Vector<Float>(iLength, true);
		...
		public static function calculateFaceNormal(v0x:Number, v0y:Number, v0z:Number, v1x:Number, v1y:Number, v1z:Number, v2x:Number, v2y:Number, v2z:Number):Vector3f
		{
		...
		public static function buildVerexTangents(normals:Vector<Float>):Vector<Float>
		{
			...
			var tangents:Vector<Float> = new Vector<Float>(normalSize, true);
