...
class MotionTrack extends AbstractCinematicTrack,implements Control
{
	...
	private var directionType:Direction;
     ...
     */
	public function new(spatial:Spatial, path:MotionPath, initialDuration:Float = 10, loopMode:LoopMode = null) 
	{
     ...
     */
    public function getDirectionType():Direction 
	{
     ...
     */
    public function setDirectionType(directionType:Direction):Void 
	{
