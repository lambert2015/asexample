...
class Plane
{
     ...
     */
	public inline function setNormal(normal:Vector3f):Void
	{
		this.normal.copyFrom(normal);
	}
     ...
     */
    public inline function setConstant(constant:Float):Void
	{
        this.constant = constant;
    }
     ...
     *            the third point
     */
    public function setPoints(v1:Vector3f, v2:Vector3f, v3:Vector3f) 
	{
		normal.copyFrom(v2);
